      ...
      <div class="box">
        <form action="" method="post">
          ...
          <select name="std_class" id="std_class" class="form-control mb-2" required>
            <?php while ($displayClass_f = mysqli_fetch_assoc($displayClass)) { ?>
              <option value="<?php echo $displayClass_f['s_id'] ?>"><?php echo $displayClass_f['s_class']; ?></option>
            <?php } ?>
          </select>
          ...
          <select name="std_section" id="section" class="form-control mb-2" required>
            <?php while ($sectionDisplay_f = mysqli_fetch_assoc($sectionDisplay)) { ?>
              <option value="<?php echo $sectionDisplay_f['id'] ?>"><?php echo $sectionDisplay_f['s_section']; ?></option>
            <?php } ?>
          </select>
          ...
          <select name="std_session" id="session" class="form-control mb-2" required>
            <?php while ($sessiondata_f = mysqli_fetch_assoc($sessiondata)) { ?>
              <option value="<?php echo  $sessiondata_f['id'] ?>"><?php echo  $sessiondata_f['s_session']; ?></option>
            <?php } ?>
          </select>
